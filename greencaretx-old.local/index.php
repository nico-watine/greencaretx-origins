...
<head>
    ...
    <body>
        <div class="container_cover_index" id="container_cover_index">
            <img src="images/Logos/logo-index.jpg" />
        </div>   
...
<div id="inline1" class="inline_contact">
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				$('#logo_fadein').hide().delay(2500).fadeIn('.0000005');
				$('#lower_div').hide().delay(2500).fadeIn('.0000005');
				$('#container_cover_index').delay(2500).fadeOut('.0000005');
				$('#fade_background').hide().delay(4600).fadeIn('.0000005');
				$('#fade_content').hide().delay(5200).fadeIn('.0000005');
				$('#container_cover').delay(5700).fadeOut('.0000005');
				$('#contact_tab').hide().delay(6100).fadeIn('.0000005');
				});
